            ...
            <div id='page-2' class='page two'>
              ...
              <div className='resume-wrap d-flex ftco-animate'>
                ...
                <div className='text pl-3'>
                  ...
                  <span className='position'>DocuSign</span>
                  <p>
                    Software Developer in the In-Product Communication project
                    which is a IPC is a robust rules-based engine that will
                    power targeted, relevant and contextual in-product content,
                    offers and messaging (“campaigns”), and will enable these
                    campaigns to be launched and improved rapidly to accelerate
              ...
              <div className='resume-wrap d-flex ftco-animate'>
                ...
                <div className='text pl-3'>
                  <span className='date'>Jul, 2019 - Jun, 2020</span>
                  <h2>Software Engineer</h2>
